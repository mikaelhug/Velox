...
struct FileLock {
    ...
    init(at url: URL) throws {
        ...
        // Blocking: contention here is another process finishing one small JSON write, so
        // waiting is right where failing would leave the caller with nothing to do about it.
